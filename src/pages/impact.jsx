    ...
    return (
        <Layout>
            ...
            <Section orient='center'>
                <Header style={{marginTop: '100px', marginBottom: '-50px'}}>Preserving our earth</Header>
            </Section>
            <Section orient='left' img='/covers/cover001.jpg'>
                <Description>
            ...
            <Section orient='right' img='/covers/cover001.jpg'>
                <Description  style={{marginBottom: '100px'}}>
            ...
            <Section orient='right' img='/covers/cover001.jpg' background='#000000'>
                <Description>
            ...
            <Section orient='left' img='/covers/cover001.jpg' background='#000000'>
                <Description  style={{marginBottom: '100px'}}>
